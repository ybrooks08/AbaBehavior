  ...
  public class AbaDbContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<ProblemBehavior>().HasData(
        ...
        new ProblemBehavior { ProblemId = 4, ProblemBehaviorDescription = "Task Refusal", IsPercent = true },
      ...
      modelBuilder.Entity<CompetencyCheckParam>().HasData(
        ...
        new CompetencyCheckParam { CompetencyCheckParamId = 10, CompetencyCheckType = CompetencyCheckType.Rbt, Description = "Followed recommended intervention procedures upon occurrence of problem behavior in session", Comment = "" },
    ...
    public DbSet<SessionCollectBehaviorV2> SessionCollectBehaviorsV2 { get; set; }
