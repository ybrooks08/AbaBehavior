    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsProblems", x => new { x.ClientId, x.ProblemId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsReplacements", x => new { x.ClientId, x.ReplacementId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionCollectBehaviors_Sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionSign", x => x.SessionSignId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ProblemId", "Active", "ProblemBehaviorDescription" },
                values: new object[,]
                {
                    { 17, true, "Property Destructions" },
                    { 18, true, "Lying" },
                    { 19, true, "Cheating" },
                    { 20, true, "Impulsive Behavior" },
                    { 22, true, "Echolalia" },
                    { 23, true, "Hyper-reactivity to sensory input" },
                    { 24, true, "Hypo-reactivity to sensory input" },
                    { 26, true, "Difficulty with receptive language" },
                    { 27, true, "Difficulty with expressive language" },
                    { 28, true, "Bolting" },
                    { 29, true, "Saliva play or smearing" },
                    { 16, true, "Bruxism" },
                    { 25, true, "Insomnia" },
                    { 15, true, "Climbing-presenting risk of fall" },
                    { 21, true, "Vocal or Auditory stereotypy" },
                    { 13, true, "Biting Self" },
                    { 14, true, "Outburst Behavior" },
                    { 1, true, "Temper Tantrum" },
                    { 2, true, "Elopement" },
                    { 4, true, "Task Refusal" },
                    { 5, true, "Physical Aggression " },
                    { 6, true, "Verbal aggression" },
                    { 3, true, "Defiant behavior" },
                    { 8, true, "Hyperactive Behavior/Out of sit behavior" },
                    { 9, true, "Inattentive behavior/Off task behavior" },
                    { 10, true, "Disruptive behavior" },
                    { 11, true, "Mouthing unsafe objects" },
                    { 12, true, "Pica" },
                    { 7, true, "Self Injury Behavior" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionCollectBehaviors_SessionId",
