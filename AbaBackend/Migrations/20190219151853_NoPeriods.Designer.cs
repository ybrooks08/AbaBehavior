...
namespace AbaBackend.Migrations
{
    ...
    [Migration("20190219151853_NoPeriods")]
    partial class NoPeriods
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientProblemSto", b =>
                {
                    ...
                    b.Property<int?>("ClientProblemClientId");

                    b.Property<int>("ClientProblemId");

                    b.Property<int?>("ClientProblemProblemId");
                    ...
                    b.HasIndex("ClientProblemClientId", "ClientProblemProblemId");
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientReplacementSto", b =>
                {
                    ...
                    b.Property<int?>("ClientReplacementClientId");

                    b.Property<int>("ClientReplacementId");

                    b.Property<int?>("ClientReplacementReplacementId");
                    ...
                    b.HasIndex("ClientReplacementClientId", "ClientReplacementReplacementId");
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientProblemSto", b =>
                {
                    b.HasOne("AbaBackend.DataModel.ClientProblem")
                        .WithMany("STOs")
                        .HasForeignKey("ClientProblemClientId", "ClientProblemProblemId");
                });
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientReplacementSto", b =>
                {
                    b.HasOne("AbaBackend.DataModel.ClientReplacement")
                        .WithMany("STOs")
                        .HasForeignKey("ClientReplacementClientId", "ClientReplacementReplacementId");
                });
            ...
            modelBuilder.Entity("AbaBackend.DataModel.PeriodClientProblem", b =>
                {
                    b.HasOne("AbaBackend.DataModel.Period")
                        .WithMany("PeriodClientProblems")
            ...
            modelBuilder.Entity("AbaBackend.DataModel.PeriodClientReplacement", b =>
                {
                    b.HasOne("AbaBackend.DataModel.Period")
                        .WithMany("PeriodClientReplacements")
                        .HasForeignKey("PeriodId")
                        .OnDelete(DeleteBehavior.Cascade);
