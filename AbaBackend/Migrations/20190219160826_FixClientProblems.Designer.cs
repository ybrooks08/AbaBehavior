...
namespace AbaBackend.Migrations
{
    ...
    [Migration("20190219160826_FixClientProblems")]
    partial class FixClientProblems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientProblem2", b =>
                {
                    b.Property<int>("ClientProblem2Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ClientProblem2Id");

                    b.HasIndex("ProblemId");

                    b.ToTable("ClientProblems2");
                });
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientProblemSto", b =>
                {
                    ...
                    b.HasIndex("ClientProblem2Id");

                    b.ToTable("ClientProblemSTOs");
                });

            modelBuilder.Entity("AbaBackend.DataModel.ClientReplacement2", b =>
                {
                    b.Property<int>("ClientReplacement2Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ClientReplacement2Id");

                    b.HasIndex("ReplacementId");

                    b.ToTable("ClientReplacements2");
                });
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientReplacementSto", b =>
                {
                    ...
                    b.HasIndex("ClientReplacement2Id");
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientProblemSto", b =>
                {
                    b.HasOne("AbaBackend.DataModel.ClientProblem2")
                        .WithMany("STOs")
                        .HasForeignKey("ClientProblem2Id");
                });
            ...
            modelBuilder.Entity("AbaBackend.DataModel.ClientReplacementSto", b =>
                {
                    b.HasOne("AbaBackend.DataModel.ClientReplacement2")
                        .WithMany("STOs")
                        .HasForeignKey("ClientReplacement2Id");
                });
